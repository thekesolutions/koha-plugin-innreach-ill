package INNReach::BackgroundJobs::BorrowingSite::ItemReceived;
...
INNReach::BackgroundJobs::BorrowingSite::ItemReceived - Background task for notifying
...
sub job_type {
    return 'plugin_innreach_b_item_received';
}
