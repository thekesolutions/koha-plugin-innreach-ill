package INNReach::BackgroundJobs::BorrowingSite::ItemInTransit;
...
INNReach::BackgroundJobs::BorrowingSite::ItemInTransit - Background task for notifying
an item has been shipped back to the owning site.
...
sub job_type {
    return 'plugin_innreach_b_item_in_transit';
}
...
sub process {
    ...
    my $commands = INNReach::Commands::BorrowingSite->new( { plugin => Koha::Plugin::Com::Theke::INNReach->new } );
