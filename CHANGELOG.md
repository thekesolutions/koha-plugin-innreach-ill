...
### Fixed
- [#19] Auto-recover from central ITEM RECEIVED rejection when status is stale, and add manual override in background job UI
...
### Fixed
- [#16] Send non_local_loans in verifypatron endpoint

## [5.5.5] - 2026-04-23

### Fixed
- [#13] Contributed item availability not updated when local hold is set to waiting

## [5.5.4] - 2025-12-22

### Fixed
- [#12] Fix `after_item_action` hook flow preventing item status updates on checkin
